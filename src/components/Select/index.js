              ...
              {!titleEmpty && (
                <li>
                  <button type="button" onClick={() => changeValue("")}>
                    <input type="radio" checked={value === ""} readOnly /> Toutes
                  </button>
                </li>
              )}
              {selection.map((s) => (
                <li key={s}>
                  <button type="button" onClick={() => changeValue(s)}>
                    <input type="radio" checked={value === s} readOnly /> {s}
                  </button>
                </li>
              ))}
            </>
...
const Select = ({ selection, label, titleEmpty, onChange, value }) => (
  <div className="selectField">
    <span>{label}</span>
    <select onChange={onChange} value={value}>
      {titleEmpty && <option value="">-- Sélectionner --</option>}
      {selection.map((item) => (
